...
/**
 * Created by ValiantAzarya on 30/11/2016.
 */
public class Server {
    public static final String URL = "http://notes.azarya.xyz/gobs_enlightment/";
    ...
    public static final String delete_upload = "delete_upload.php";
    public static final String insert_upload = "insert_upload.php";
    public static final String update_upload = "update_module.php";
    ...
    public static final String getModuleDetails = "get_module_details.php";
}
